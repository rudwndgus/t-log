...
export default function App() {
  return <><CloudErrorBanner /><Routes><Route path="/" element={<HomePage />} /><Route path="/auth" element={<AuthPage />} /><Route path="/create" element={<CloudAuthGate><CreateTripPage /></CloudAuthGate>} /><Route path="/join" element={<JoinTripPage />} /><Route path="/join/:inviteCode" element={<JoinTripPage />} /><Route path="/shared/:shareId" element={<PublicTripPage />} /><Route path="/trip/:tripId" element={<CloudAuthGate><TripLayout /></CloudAuthGate>}><Route index element={<Navigate to="note" replace />} /><Route path="note" element={<NoteScreen />} /><Route path="note/:pageId" element={<NoteScreen />} /><Route path="map" element={<MapScreen />} /><Route path="chat" element={<ChatScreen />} /></Route><Route path="*" element={<Navigate to="/" replace />} /></Routes></>
}
