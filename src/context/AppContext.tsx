...
interface AppContextValue {
  ...
  createTrip: (input: CreateTripInput) => Promise<Trip>; joinTrip: (code: string) => Trip | null; joinCloudTrip: (code: string) => Promise<string>
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const unsubscribeAuth = onAuthStateChanged(firebaseAuth, (user) => {
      ...
      void saveProfile(database, nextProfile).catch((error) => reportCloudError('save-profile', error, { userId: user.uid }))
